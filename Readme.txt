...
│
├── myinfo/
│   └── experience.html     - Experience and Skills page. Contains work experience,
│                         skills, and hobbies.
│   └── contact.html        - Contact page. Contains contact details and references.
│
├── images/
│   └── Dorcas1.jpeg    - Profile photo used on the Home page.
│
...
1. index.html (Home)
   ...
   - Education history in a table

2. experience.html (Experience & Skills)
   - Navigation bar linking all three pages
   - Work and university experience in a table
   - List of skills
   - Hobbies and interests

3. contact.html (Contact)
   - Navigation bar linking all three pages
   - Contact details (name, email, location) in a table
...
- All pages have been validated using the W3C Markup Validation Service
  (https://validator.w3.org). Evidence of validation is included in the report.
